...
public class Lizard {
	...
	//Objects associated with the lizard class
	private Date birthDate;
	
	//Constructor of the lizard class
	public Lizard(String name, String sex, String bloodType, double height, double weight, Date birthDate) {
		this.name = name;
		this.sex = sex;
